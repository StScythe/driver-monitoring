...
# «Исследование и разработка адаптивного политопного метода детекции опасных состояний водителя на основе анализа видеоданных»

**Автор:** Волкова Н.В.

**Роль в проекте:** научное обоснование выбора геометрических признаков, статистический анализ, ML-верификация, расчет коэффициентов адаптивного порога, экспериментальное сравнение политопных методов детекции.
...
### 3.3. Коэффициенты адаптивного порога
...
## 4. ML-верификация информативности признаков
...
### 5.1. 1D-политоп (только MAR) — пакетная обработка (22 видео)
...
| 02 | `scientific_analysis.ipynb` | Статистика, расчет K, ML-верификация |
